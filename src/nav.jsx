...
export default function Nav({ setCurrentPage, activePage }) {
  return (
    <nav className="w-72 h-screen bg-neutral-800 flex flex-col p-6 border-r border-neutral-700">
      
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white tracking-tight">
          DocFlow
        </h1>
        <p className="text-blue-200 text-xs uppercase mt-1">
          Automatisation de conversion
        </p>
      </div>

      <hr className="border-t border-blue-200 mb-5" />
      ...
      <div className="flex flex-col gap-4 flex-1">
        ...
        >
          <span className="text-xl">+</span> Nouveau Flow
        </button>
